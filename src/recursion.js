...
var arraySum = function(array) {
  var stringArr = array.toString();
  var splitArr = stringArr.split(",").map(Number);
  if (array.length === 0) {
    return 0;
  } else {
    return splitArr[0] + arraySum(splitArr.slice(1));
  }
};
...
//racecar = true
  ...
  //hannah
    // check first and last element
      //if same, slice the string and remove the first and last. get the middle parts
        //check again the first and last of the middle parts
